...
themes.view.Theme = wp.Backbone.View.extend({
	...
	// Handles .enabled classes for previous/next buttons in theme installer preview.
...
themes.view.Details = wp.Backbone.View.extend({
	...
	containFocus: function( $el ) {
		...
		$el.on( 'keydown.wp-themes', function( event ) {
			var $firstFocusable = $el.find( '.theme-header button:not(.enabled)' ).first(),
	...
	// Handles .enabled classes for next/previous buttons.
	navigation: function() {
