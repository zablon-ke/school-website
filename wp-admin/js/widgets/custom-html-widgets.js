...
wp.customHtmlWidgets = ( function( $ ) {
	...
	component.CustomHtmlWidgetControl = Backbone.View.extend(/** @lends wp.customHtmlWidgets.CustomHtmlWidgetControl.prototype */{
		...
		initialize: function initialize( options ) {
			...
			control.$el.html( wp.template( 'widget-custom-html-control-fields' )( { codeEditorenabled: component.codeEditorSettings.enabled } ) );
		...
		initializeEditor: function initializeEditor() {
			...
			if ( component.codeEditorSettings.enabled ) {
				return;
			}
			...
			settings = _.extend( {}, component.codeEditorSettings, {
				...
				onUpdateErrorNotice: function onUpdateErrorNotice( errorAnnotations ) {
					control.saveButton.toggleClass( 'validation-blocked enabled', errorAnnotations.length > 0 );
