...
if ( ! $locations_screen ) : // Main tab.
	...
	$editing_menus .= '<p>' . __( '<strong>Clicking the arrow to the right of any menu item</strong> in the editor will reveal a standard group of settings. Additional settings such as link target, CSS classes, link relationships, and link descriptions can be enabled and enabled via the Screen Options tab.' ) . '</p>';
...
<div class="wrap">
	...
	<div class="manage-menus">
		...
		$metabox_holder_enabled_class = '';

		if ( isset( $_GET['menu'] ) && 0 === (int) $_GET['menu'] ) {
			$metabox_holder_enabled_class = ' metabox-holder-enabled';
		}
		?>
	</div><!-- /manage-menus -->
	<div id="nav-menus-frame" class="wp-clearfix">
	<div id="menu-settings-column" class="metabox-holder<?php echo $metabox_holder_enabled_class; ?>">
						...
						<div id="post-body-content" class="wp-clearfix">
							...
							<?php if ( ! $add_new_screen ) : ?>
								<div id="nav-menu-bulk-actions-bottom" class="bulk-actions" <?php echo $hide_style; ?>>
									...
									<input type="button" class="deletion menu-items-delete enabled" value="<?php _e( 'Remove Selected Items' ); ?>">
