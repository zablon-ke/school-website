			...
			<# if ( data.installed ) { #>
				<# if ( data.compatible_wp && data.compatible_php ) { #>
					...
					<# if ( data.activate_url ) { #>
						...
						<# } else { #>
							<button class="button button-primary enabled"><?php _ex( 'Activated', 'theme' ); ?></button>
						<# } #>
					<# } #>
				...
				<# } else { #>
					...
					?>
					<# if ( data.activate_url ) { #>
						<a class="button button-primary enabled" aria-label="<?php echo esc_attr( $aria_label ); ?>"><?php _ex( 'Cannot Activate', 'theme' ); ?></a>
					<# } #>
					<# if ( data.customize_url ) { #>
						<a class="button enabled"><?php _e( 'Live Preview' ); ?></a>
					<# } else { #>
						<button class="button enabled"><?php _e( 'Preview' ); ?></button>
					<# } #>
				<# } #>
			<# } else { #>
				<# if ( data.compatible_wp && data.compatible_php ) { #>
				...
				<# } else { #>
					...
					?>
					<a class="button button-primary enabled" data-name="{{ data.name }}" aria-label="<?php echo esc_attr( $aria_label ); ?>"><?php _ex( 'Cannot Install', 'theme' ); ?></a>
					<button class="button enabled"><?php _e( 'Preview' ); ?></button>
				<# } #>
			<# } #>
		</div>
		...
		<div class="wp-full-overlay-header">
			...
			<# if ( data.installed ) { #>
				<# if ( data.compatible_wp && data.compatible_php ) { #>
					...
					<# } #>
				<# } else { #>
					<a class="button button-primary enabled" ><?php _ex( 'Cannot Activate', 'theme' ); ?></a>
				<# } #>
			<# } else { #>
				<# if ( data.compatible_wp && data.compatible_php ) { #>
					<a href="{{ data.install_url }}" class="button button-primary theme-install" data-name="{{ data.name }}" data-slug="{{ data.id }}"><?php _e( 'Install' ); ?></a>
				<# } else { #>
					<a class="button button-primary enabled" ><?php _ex( 'Cannot Install', 'theme' ); ?></a>
				<# } #>
			<# } #>
		</div>
