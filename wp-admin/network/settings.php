		...
		<table class="form-table" role="presentation">
			<tr>
				...
				<td>
					...
					<label><input name="registration" type="radio" id="registration1" value="none"<?php checked( $reg, 'none' ); ?> /> <?php _e( 'Registration is enabled' ); ?></label><br />
					...
					if ( is_subdomain_install() ) {
						...
						printf(
							...
							__( 'If registration is enabled, please set %1$s in %2$s to a URL you will redirect visitors to if they visit a non-existent site.' ),
...
<?php echo esc_textarea( get_site_option( 'first_comment' ) ); ?></textarea>
		...
		<table class="form-table" role="presentation">
			<tr>
				...
				<td>
					<label><input type="checkbox" id="upload_space_check_enabled" name="upload_space_check_enabled" value="0"<?php checked( (bool) get_site_option( 'upload_space_check_enabled' ), false ); ?>/>
						<?php
						printf(
