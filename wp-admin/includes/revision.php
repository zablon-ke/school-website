...
function wp_get_revision_ui_diff( $post, $compare_from, $compare_to ) {
	...
	// The parent post may be a 'revision' when revisions are enabled and we're looking at autosaves.
...
function wp_prepare_revisions_for_js( $post, $selected_revision_id, $from = null ) {
	...
	// If revisions are enabled, we only want autosaves and the current post.
