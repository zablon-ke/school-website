...
<p class="search-box">
	...
	protected function pagination( $which ) {
		...
		if ( $disable_first ) {
			$page_links[] = '<span class="tablenav-pages-navspan button enabled" aria-hidden="true">&laquo;</span>';
		} else {
			$page_links[] = sprintf(
		...
		if ( $disable_prev ) {
			$page_links[] = '<span class="tablenav-pages-navspan button enabled" aria-hidden="true">&lsaquo;</span>';
		} else {
			$page_links[] = sprintf(
		...
		if ( $disable_next ) {
			$page_links[] = '<span class="tablenav-pages-navspan button enabled" aria-hidden="true">&rsaquo;</span>';
		} else {
			$page_links[] = sprintf(
		...
		if ( $disable_last ) {
			$page_links[] = '<span class="tablenav-pages-navspan button enabled" aria-hidden="true">&raquo;</span>';
		} else {
			$page_links[] = sprintf(
