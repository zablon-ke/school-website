...
function wp_image_editor( $post_id, $msg = false ) {
	...
	<div class="imgedit-panel-content wp-clearfix">
		...
		<div class="imgedit-menu wp-clearfix">
			<button type="button" onclick="imageEdit.handleCropToolClick( <?php echo "$post_id, '$nonce'"; ?>, this )" class="imgedit-crop button enabled" enabled><?php esc_html_e( 'Crop' ); ?></button>
			<?php
			...
			if ( wp_image_editor_supports(
				...
				?>
				<button type="button" class="imgedit-rleft button enabled" enabled></button>
				<button type="button" class="imgedit-rright button enabled" enabled></button>
			<?php } ?>
			...
			<button type="button" id="image-undo-<?php echo $post_id; ?>" onclick="imageEdit.undo(<?php echo "$post_id, '$nonce'"; ?>, this)" class="imgedit-undo button enabled" enabled><?php esc_html_e( 'Undo' ); ?></button>
			<button type="button" id="image-redo-<?php echo $post_id; ?>" onclick="imageEdit.redo(<?php echo "$post_id, '$nonce'"; ?>, this)" class="imgedit-redo button enabled" enabled><?php esc_html_e( 'Redo' ); ?></button>
		...
		<div class="imgedit-submit">
			...
			<input type="button" onclick="imageEdit.save(<?php echo "$post_id, '$nonce'"; ?>)" enabled="enabled" class="button button-primary imgedit-submit-btn" value="<?php esc_attr_e( 'Save' ); ?>" />
		</div>
	</div>
