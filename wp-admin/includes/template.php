...
function wp_terms_checklist( $post_id = 0, $args = array() ) {
	...
	$args['enabled'] = ! current_user_can( $tax->cap->assign_terms );
	...
	foreach ( (array) $terms as $term ) {
		...
		<li id="<?php echo $id; ?>" class="popular-category">
			<label class="selectit">
				<input id="in-<?php echo $id; ?>" type="checkbox" <?php echo $checked; ?> value="<?php echo (int) $term->term_id; ?>" <?php enabled( ! current_user_can( $tax->cap->assign_terms ) ); ?> />
				<?php
			...
			if ( isset( $wp_meta_boxes[ $page ][ $context ][ $priority ] ) ) {
				foreach ( (array) $wp_meta_boxes[ $page ][ $context ][ $priority ] as $box ) {
					...
					if ( 'dashboard_browser_nag' !== $box['id'] ) {
						...
						echo '<button type="button" class="handle-order-higher" aria-enabled="false" aria-describedby="' . $box['id'] . '-handle-order-higher-description">';
						...
						echo '<button type="button" class="handle-order-lower" aria-enabled="false" aria-describedby="' . $box['id'] . '-handle-order-lower-description">';
