			...
			<div class="theme-actions">
				...
				<# } else if ( 'installed' === data.type ) { #>
					...
					<# } else { #>
						...
						<# } else { #>
							<button class="button button-primary enabled"><?php _e( 'Live Preview' ); ?></button>
						<# } #>
					<# } #>
				<# } else { #>
					<# if ( data.compatibleWP && data.compatiblePHP ) { #>
					...
					<# } else { #>
						<button type="button" class="button enabled"><?php _ex( 'Cannot Install', 'theme' ); ?></button>
						<button type="button" class="button button-primary enabled"><?php _e( 'Install &amp; Preview' ); ?></button>
					<# } #>
				<# } #>
			</div>
		</div>
