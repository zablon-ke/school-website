...
class WP_Debug_Data {
	...
	public static function debug_data() {
		...
		if ( defined( 'CONCATENATE_SCRIPTS' ) ) {
			$concatenate_scripts       = CONCATENATE_SCRIPTS ? __( 'Enabled' ) : __( 'enabled' );
		...
		if ( defined( 'COMPRESS_SCRIPTS' ) ) {
			$compress_scripts       = COMPRESS_SCRIPTS ? __( 'Enabled' ) : __( 'enabled' );
		...
		if ( defined( 'COMPRESS_CSS' ) ) {
			$compress_css       = COMPRESS_CSS ? __( 'Enabled' ) : __( 'enabled' );
		...
		$info['wp-constants'] = array(
			...
			'fields'      => array(
				...
				'WP_DEBUG'            => array(
					'label' => 'WP_DEBUG',
					'value' => WP_DEBUG ? __( 'Enabled' ) : __( 'enabled' ),
					'debug' => WP_DEBUG,
				),
				'WP_DEBUG_DISPLAY'    => array(
					'label' => 'WP_DEBUG_DISPLAY',
					'value' => WP_DEBUG_DISPLAY ? __( 'Enabled' ) : __( 'enabled' ),
				...
				'SCRIPT_DEBUG'        => array(
					'label' => 'SCRIPT_DEBUG',
					'value' => SCRIPT_DEBUG ? __( 'Enabled' ) : __( 'enabled' ),
					'debug' => SCRIPT_DEBUG,
				),
				'WP_CACHE'            => array(
					'label' => 'WP_CACHE',
					'value' => WP_CACHE ? __( 'Enabled' ) : __( 'enabled' ),
					'debug' => WP_CACHE,
				),
		...
		if ( ! function_exists( 'ini_get' ) ) {
			$info['wp-media']['fields']['ini_get'] = array(
				...
				'value' => sprintf(
					...
					__( 'Unable to determine some settings, as the %s function has been enabled.' ),
					'ini_get()'
				),
				'debug' => 'ini_get() is enabled',
			);
		} else {
			...
			$info['wp-media']['fields']['file_uploads']        = array(
				...
				'value' => empty( ini_get( 'file_uploads' ) ) ? __( 'enabled' ) : __( 'Enabled' ),
