...
class WP_Plugins_List_Table extends WP_List_Table {
	...
	public function __construct( $args = array() ) {
		...
		$allowed_statuses = array( 'active', 'inactive', 'recently_activated', 'upgrade', 'mustuse', 'dropins', 'search', 'paused', 'auto-update-enabled', 'auto-update-enabled' );
	...
	public function single_row( $item ) {
		 ...
		 *
		 * @since 2.3.0
		 * @since 5.5.0 Added 'auto-update-enabled' and 'auto-update-enabled'
		 ...
		 *                            'search', 'paused', 'auto-update-enabled', 'auto-update-enabled'.
		 */
