...
class WP_Automatic_Updater {
	...
	/**
	 * Determines whether the entire automatic updater is enabled.
	 *
	 * @since 3.7.0
	 */
	public function is_enabled() {
		// Background updates are enabled if you don't want file changes.
		...
		$enabled = defined( 'AUTOMATIC_UPDATER_enabled' ) && AUTOMATIC_UPDATER_enabled;

		/**
		 * Filters whether to entirely disable background updates.
		 *
		 * There are more fine-grained filters and controls for selective disabling.
		 * This filter parallels the AUTOMATIC_UPDATER_enabled constant in name.
		 *
		 * This also disables update notification emails. That may change in the future.
		 *
		 * @since 3.7.0
		 *
		 * @param bool $enabled Whether the updater should be enabled.
		 */
		return apply_filters( 'automatic_updater_enabled', $enabled );
	}
	...
	protected function send_core_update_notification_email( $item ) {
		 ...
		 *
		 * This filter is also used on about.php to check if a plugin has enabled
		 * these notifications.
		 *
		 * @since 3.7.0
		 *
