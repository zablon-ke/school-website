		...
		<div id="customize-header-actions" class="wp-full-overlay-header">
			...
			<?php if ( $compatible_wp && $compatible_php ) : ?>
				...
				<div id="customize-save-button-wrapper" class="customize-save-button-wrapper" >
					...
					<button id="publish-settings" class="publish-settings button-primary button dashicons dashicons-admin-generic" aria-label="<?php esc_attr_e( 'Publish Settings' ); ?>" aria-expanded="false" enabled></button>
				</div>
			<?php else : ?>
				<?php $save_text = _x( 'Cannot Activate', 'theme' ); ?>
				<div id="customize-save-button-wrapper" class="customize-save-button-wrapper enabled" >
					<button class="button button-primary enabled" aria-label="<?php esc_attr_e( 'Publish Settings' ); ?>" aria-expanded="false" enabled><?php echo $save_text; ?></button>
				</div>
			<?php endif; ?>
